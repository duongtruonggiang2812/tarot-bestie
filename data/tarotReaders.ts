...
export const TAROT_READERS: TarotReader[] = [
  {
    ...
    quote: "Khi vũ trụ lên tiếng, ta chỉ là người truyền thông điệp.",
...
4. **Kết** — 1 câu tiên tri tiếp thêm sức mạnh`,
...

  {
    ...
    quote: "Tarot không nói dối — chỉ có mày chưa dám nghe thôi.",
...
4. **Bottom line** — 1 câu tóm tắt thẳng nhất`,
...

  {
    ...
    quote: "Tarot không quyết định số phận — nó chỉ cho bạn thấy những lựa chọn.",
...
4. **Lời nhắn** — điều tốt đẹp bạn đang xây dựng`,
...

  {
    ...
    quote: "Năng lượng bạn mang theo chính là lời thì thầm của linh hồn.",
